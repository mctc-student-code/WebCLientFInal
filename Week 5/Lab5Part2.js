...
let AudCalc = rates['AUD'] 
console.log(rates)
console.log(AudCalc)
let dollarConvert = AudCalc * 100
console.log(dollarConvert)
...
cats_and_owners.forEach(one_cat_and_owner => {
 console.log(one_cat_and_owner)
 console.log(one_cat_and_owner.name + " cat's name is "+ one_cat_and_owner.cat)
});
